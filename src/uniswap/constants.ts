...
import { Token, Percent, SupportedChainId } from "@uniswap/sdk-core";
...
export const ERC20_TRANSFER_GAS_LIMIT = BigInt(200000); // conservatively high
export const GAS_MULTIPLIER = BigInt(2);
